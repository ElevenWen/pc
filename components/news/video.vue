...
#app,.container,.__cov-video-container{
    height: 100%;
}
...
<template>
    <div id="app">
        <div class="container">
            <div class="__cov-video-container" @mouseenter="mouseEnterVideo" @mouseleave="mouseLeaveVideo"  v-if="sssss">
                <!-- <object width="400" height="400" data="helloworld.swf"></object> -->
                <object :class="{ 'hide-cursor': !state.contrlShow }" class="__cov-video" :poster="options.poster">
                     <source v-for="source in sources" :src="source.src" :type="source.type">
                    </source>

                </object>
                <!-- <object width="950" height="482" class="player" id="player_placeholder"  data="http://manage.wqbol.net/Upload/Video/20180515//a05e8005-ed41-4443-a1f4-065d1b45fb70.mp4" type="application/x-shockwave-flash" style="visibility: visible;">
                    <param name="bgcolor" value="#ffffff"><param name="allowfullscreeninteractive" value="true">
                    <param name="allowfullscreen" value="true"><param name="quality" value="high"><param name="allowscriptaccess" value="always">
                    <param name="wmode" value="direct"><param name="flashvars" value="cid=38959666&amp;aid=23376620&amp;pre_ad=">
                </object> -->
    ...
    methods: {
        ...
        getTime () {
            this.$video.addEventListener('durationchange', (e) => {
                this.video.displayTime = timeParse(this.$video.duration);
            })
