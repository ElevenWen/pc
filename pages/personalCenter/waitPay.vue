			...
			<div class="all_order_form">
				<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
				    <ul class="layui-tab-title">
                        ...
                        <nuxt-link to="/personalCenter/waitPay" tag="li" class="layui-this">待付款<span v-if="waitPay">{{waitPay}}</span></nuxt-link>
										...
										<tbody class="color_DD">
											<tr>
												...
												<td>
													...
													<span class="otherPeople" @click="otherPay(item)">找人代付</span>
